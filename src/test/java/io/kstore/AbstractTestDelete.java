...
public abstract class AbstractTestDelete extends AbstractTest {
    ...
    public void testDeleteAllColumnVersions() throws IOException {
        ...
        Assert.assertTrue(
            "Qual2 should be intact", result.containsColumn(COLUMN_FAMILY, qual2));
        Assert.assertArrayEquals(
            "Qual2 value should match",
            qual2,
            CellUtil.cloneQualifier(
                result.getColumnLatestCell(COLUMN_FAMILY, qual2)));
    ...
    public void testDeleteOlderFamilyColumns() throws IOException {
        ...
        Assert.assertTrue(
            ...
            result.containsColumn(COLUMN_FAMILY, qual1));
        Assert.assertEquals(
            "Version 3 should be the only version",
            3L,
    ...
    public void testDeleteFamilyWithSpecificTimestamp() throws IOException {
        ...
        Assert.assertTrue(
            "Qual1 should have cells", result.containsColumn(COLUMN_FAMILY, qual1));
        Assert.assertTrue(
            "Qual2 should have a cell", result.containsColumn(COLUMN_FAMILY, qual2));
